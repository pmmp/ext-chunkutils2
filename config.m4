...
if test "$PHP_CHUNKUTILS2" != "no"; then
  ...
  PHP_NEW_EXTENSION(chunkutils2, chunkutils2.cpp src/PhpPalettedBlockArray.cpp src/PhpSubChunkConverter.cpp, $ext_shared,, -DZEND_ENABLE_STATIC_TSRMLS_CACHE=1 -std=c++14 -fno-strict-aliasing -DGSL_THROW_ON_CONTRACT_VIOLATION=1)
